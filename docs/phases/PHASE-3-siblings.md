...
Three small additive PRs in the sibling repos + Sukumo's clients. Needs HANDOFF Q7
...
4. Sukumo `clients/michi|kakeibo|mishka.py`: httpx GET, 3s timeout, snapshot row
...
- [ ] Sukumo `/api/status` shows all three green with real latencies; stopping
